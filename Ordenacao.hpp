...
public:
    ...
    static void quickSortHoare(std::vector<int> &vec); // usa o método de partição mas usando o primeiro elemento como pivô
    ...
    static void mergeSort(std::vector<int> &vec); // divide o vetor principal em sub vetores ordena e os mescla
};
